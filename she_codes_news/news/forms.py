...
class StoryForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'content': forms.TextInput(attrs={'class':'form-control', 'placeholder':'Input the content here'}),
            'image_url': forms.TextInput(attrs={'class':'form-control', 'placeholder':'Input the image URL here'})
        }
